...
List dininghotel = [
  ...
  Text("Gokul Oottupura",
      style: const TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
  Text("Hotel Saravana Bhavan",
      style: const TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
  Text("Alakapuri",
      style: const TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
  Text("Hotel Aryas Purw veg",
      style: const TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
];

List image = [
  "https://www.ikea.com/images/07/a6/07a6b54ae88dc89f459a8a5dcfc7d7eb.jpg?f=s",
  "https://images.ctfassets.net/grb5fvwhwnyo/1sJpRsfp1RJI3AASMiOS1h/d5cca0a1c5d78df3052659f2b56a1225/SEO-Food-Fresh-Groceries.png",
...
List star = [Text("3.4"), Text("4.0"), Text("3.1"), Text("4.5"), Text("5.0")];
